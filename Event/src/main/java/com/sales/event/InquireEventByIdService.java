 ...
 */
@ServiceConfig(
        act = SalesActionName.inquireEventById,
        ...
        returnParameters = {"eventId","eventName", "eventStartURL", "eventEndImageURL", "eventEffectiveStartTime", "eventEffectiveEndTime", "awards","keyword","eventDesc"},
        description = "查询活动",
        validateParameters = {
