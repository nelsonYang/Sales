 ...
 */
@ServiceConfig(
        act = SalesActionName.inquireEventByTokenAndType,
        ...
        returnParameters = {"eventId", "eventName", "eventStartURL", "eventEndImageURL", "eventEffectiveStartTime", "eventEffectiveEndTime", "awards", "weixinId","eventDesc"},
        description = "查询活动",
        validateParameters = {
...
public class InquireEventByTokenAndTypeService implements Service {
