 ...
 */
@ServiceConfig(
        act = ActionNames.deleteWeiSiteSytleTemplateConfig,
        ...
        description = "删除WeiSiteSytleTemplateConfig操作",
        validateParameters = {
...
public class DeleteWeiSiteSytleTemplateConfigService implements Service {
   
    private Logger logger = LogFactory.getInstance().getLogger(DeleteWeiSiteSytleTemplateConfigService.class);
