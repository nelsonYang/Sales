 ...
 */
@ServiceConfig(
        act = ActionNames.inquirePageWeiSiteStyleTemplateList,
        ...
        description = "分页查询WeiSiteStyleTemplate",
        validateParameters = {
...
public class InquirePageWeiSiteStyleTemplateListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquirePageWeiSiteStyleTemplateListService.class);
    ...
    public void execute() {
        ...
        List<WeiSiteStyleTemplate> entityList = enityPageMode.getDataList();
        if (entityList != null) {
