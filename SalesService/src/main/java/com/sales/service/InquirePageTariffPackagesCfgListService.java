 ...
 */
@ServiceConfig(
        act = ActionNames.inquirePageTariffPackagesCfgList,
        ...
        description = "分页查询TariffPackagesCfg",
        validateParameters = {
...
public class InquirePageTariffPackagesCfgListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquirePageTariffPackagesCfgListService.class);
    ...
    public void execute() {
        ...
        List<TariffPackagesCfg> entityList = enityPageMode.getDataList();
        if (entityList != null) {
