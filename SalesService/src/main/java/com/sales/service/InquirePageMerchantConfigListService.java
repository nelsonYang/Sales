 ...
 */
@ServiceConfig(
        act = ActionNames.inquirePageMerchantConfigList,
        ...
        description = "分页查询MerchantConfig",
        validateParameters = {
...
public class InquirePageMerchantConfigListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquirePageMerchantConfigListService.class);
    ...
    public void execute() {
        ...
        List<MerchantConfig> entityList = enityPageMode.getDataList();
        if (entityList != null) {
