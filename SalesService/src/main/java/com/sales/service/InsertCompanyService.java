...
public class InsertCompanyService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InsertCompanyService.class);
    ...
    public void execute() {
        ...
        Company entity = entityDAO.insert(parameters);
        if (entity != null) {
