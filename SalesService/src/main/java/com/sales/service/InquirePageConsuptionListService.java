 ...
 */
@ServiceConfig(
        act = ActionNames.inquirePageConsuptionList,
...
public class InquirePageConsuptionListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquirePageConsuptionListService.class);
    ...
    public void execute() {
        ...
        List<Consuption> entityList = enityPageMode.getDataList();
        if (entityList != null) {
