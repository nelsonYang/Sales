 ...
 */
@ServiceConfig(
        act = ActionNames.updateWeixinToken,
...
public class UpdateWeixinTokenService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(UpdateWeixinTokenService.class);
    ...
    public void execute() {
        ...
        WeixinToken entity = entityDAO.update(parameters);
        if (entity != null) {
