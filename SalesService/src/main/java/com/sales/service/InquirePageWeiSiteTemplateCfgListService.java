 ...
 */
@ServiceConfig(
        act = ActionNames.inquirePageWeiSiteTemplateCfgList,
        ...
        description = "分页查询WeiSiteTemplateCfg",
        validateParameters = {
...
public class InquirePageWeiSiteTemplateCfgListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquirePageWeiSiteTemplateCfgListService.class);
    ...
    public void execute() {
        ...
        List<WeiSiteTemplateCfg> entityList = enityPageMode.getDataList();
        if (entityList != null) {
