 ...
 */
@ServiceConfig(
        act = ActionNames.inquirePageCompanyList,
...
public class InquirePageCompanyListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquirePageCompanyListService.class);
    ...
    public void execute() {
        ...
        List<Company> entityList = enityPageMode.getDataList();
        if (entityList != null) {
