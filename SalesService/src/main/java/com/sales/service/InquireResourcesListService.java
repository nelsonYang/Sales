 ...
 */
@ServiceConfig(
        act = ActionNames.inquireResourcesList,
...
public class InquireResourcesListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquireResourcesListService.class);
