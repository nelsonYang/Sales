 ...
 */
@ServiceConfig(
        act = ActionNames.inquirePageEventConfigList,
...
public class InquirePageEventConfigListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquirePageEventConfigListService.class);
    ...
    public void execute() {
        ...
        List<EventConfig> entityList = enityPageMode.getDataList();
        if (entityList != null) {
