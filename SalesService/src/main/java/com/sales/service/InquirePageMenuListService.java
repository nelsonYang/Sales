 ...
 */
@ServiceConfig(
        act = ActionNames.inquirePageMenuList,
        ...
        returnParameters = {"menuId","menuName","menuParent","menuType","menuURL","menuKey","companyId"},
...
public class InquirePageMenuListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquirePageMenuListService.class);
    ...
    public void execute() {
        ...
        List<Menu> entityList = enityPageMode.getDataList();
        if (entityList != null) {
