 ...
 */
@ServiceConfig(
        act = ActionNames.inquirePageWeiSiteImageList,
...
public class InquirePageWeiSiteImageListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquirePageWeiSiteImageListService.class);
    ...
    public void execute() {
        ...
        List<WeiSiteImage> entityList = enityPageMode.getDataList();
        if (entityList != null) {
