 ...
 */
@ServiceConfig(
        act = ActionNames.insertTariffPackagesCfg,
        ...
        description = "新增TariffPackagesCfg",
        validateParameters = {
...
public class InsertTariffPackagesCfgService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InsertTariffPackagesCfgService.class);
    ...
    public void execute() {
        ...
        TariffPackagesCfg entity = entityDAO.insert(parameters);
        if (entity != null) {
