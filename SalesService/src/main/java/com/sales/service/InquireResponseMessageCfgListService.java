 ...
 */
@ServiceConfig(
        act = ActionNames.inquireResponseMessageCfgList,
...
public class InquireResponseMessageCfgListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquireResponseMessageCfgListService.class);
