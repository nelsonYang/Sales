...
public class InsertMessageService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InsertMessageService.class);
    ...
    public void execute() {
        ...
        Message entity = entityDAO.insert(parameters);
        if (entity != null) {
