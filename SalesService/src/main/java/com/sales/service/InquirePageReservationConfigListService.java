 ...
 */
@ServiceConfig(
        act = ActionNames.inquirePageReservationConfigList,
        ...
        description = "分页查询ReservationConfig",
        validateParameters = {
...
public class InquirePageReservationConfigListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquirePageReservationConfigListService.class);
    ...
    public void execute() {
        ...
        List<ReservationConfig> entityList = enityPageMode.getDataList();
        if (entityList != null) {
