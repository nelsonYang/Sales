 ...
 */
@ServiceConfig(
        act = ActionNames.inquirePageEventList,
...
public class InquirePageEventListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquirePageEventListService.class);
    ...
    public void execute() {
        ...
        List<Event> entityList = enityPageMode.getDataList();
        if (entityList != null) {
