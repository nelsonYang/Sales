 ...
 */
@ServiceConfig(
        act = ActionNames.updateWeiSiteArticle,
...
public class UpdateWeiSiteArticleService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(UpdateWeiSiteArticleService.class);
    ...
    public void execute() {
        ...
        WeiSiteArticle entity = entityDAO.update(parameters);
        if (entity != null) {
