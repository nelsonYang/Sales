 ...
 */
@ServiceConfig(
        act = ActionNames.inquirePageResourcesImageList,
        ...
        description = "分页查询ResourcesImage",
        validateParameters = {
...
public class InquirePageResourcesImageListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquirePageResourcesImageListService.class);
    ...
    public void execute() {
        ...
        List<ResourcesImage> entityList = enityPageMode.getDataList();
        if (entityList != null) {
