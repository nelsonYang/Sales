 ...
 */
@ServiceConfig(
        act = ActionNames.inquireMenuById,
...
public class InquireMenuByIdService implements Service {
    ...
    private Logger logger = LogFactory.getInstance().getLogger(InquireMenuByIdService.class);
	...
	primaryKey.putKeyField("menuId",String.valueOf(menuId));
        ...
        EntityDao<Menu> entityDAO = applicationContext.getEntityDAO(EntityNames.menu);
          Menu entity = entityDAO.inqurieByKey(primaryKey);
        if (entity != null) {
