 ...
 */
@ServiceConfig(
        act = ActionNames.inquirePageWeixinTokenList,
...
public class InquirePageWeixinTokenListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquirePageWeixinTokenListService.class);
    ...
    public void execute() {
        ...
        List<WeixinToken> entityList = enityPageMode.getDataList();
        if (entityList != null) {
