 ...
 */
@ServiceConfig(
        act = ActionNames.inquirePageWeiBarList,
...
public class InquirePageWeiBarListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquirePageWeiBarListService.class);
