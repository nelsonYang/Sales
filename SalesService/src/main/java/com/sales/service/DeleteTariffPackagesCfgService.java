 ...
 */
@ServiceConfig(
        act = ActionNames.deleteTariffPackagesCfg,
        ...
        description = "删除TariffPackagesCfg操作",
        validateParameters = {
...
public class DeleteTariffPackagesCfgService implements Service {
   
    private Logger logger = LogFactory.getInstance().getLogger(DeleteTariffPackagesCfgService.class);
