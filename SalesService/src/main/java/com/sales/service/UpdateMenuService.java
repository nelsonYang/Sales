...
public class UpdateMenuService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(UpdateMenuService.class);
    ...
    public void execute() {
        ...
        Menu entity = entityDAO.update(parameters);
        if (entity != null) {
