 ...
 */
@ServiceConfig(
        act = ActionNames.insertWeiSiteTemplateCfg,
        ...
        description = "新增WeiSiteTemplateCfg",
        validateParameters = {
...
public class InsertWeiSiteTemplateCfgService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InsertWeiSiteTemplateCfgService.class);
    ...
    public void execute() {
        ...
        WeiSiteTemplateCfg entity = entityDAO.insert(parameters);
        if (entity != null) {
