 ...
 */
@ServiceConfig(
        act = ActionNames.updateWeixinMessage,
...
public class UpdateWeixinMessageService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(UpdateWeixinMessageService.class);
    ...
    public void execute() {
        ...
        WeixinMessage entity = entityDAO.update(parameters);
        if (entity != null) {
