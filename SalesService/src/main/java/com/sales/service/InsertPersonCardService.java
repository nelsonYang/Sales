 ...
 */
@ServiceConfig(
        act = ActionNames.insertPersonCard,
...
public class InsertPersonCardService implements Service {
    ...
    private Logger logger = LogFactory.getInstance().getLogger(InsertPersonCardService.class);
    ...
    public void execute() {
        ...
        PersonCard entity = entityDAO.insert(parameters);
        if (entity != null) {
