 ...
 */
@ServiceConfig(
        act = ActionNames.inquireMenuList,
...
public class InquireMenuListService implements Service {
    ...
    private Logger logger = LogFactory.getInstance().getLogger(InquireMenuListService.class);
    ...
    public void execute() {
        ...
        List<Menu> entityList = entityDAO.inquireByCondition(conditionList);
        if (entityList != null) {
