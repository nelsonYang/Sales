 ...
 */
@ServiceConfig(
        act = ActionNames.inquirePageResponseToolConfigList,
        ...
        description = "分页查询ResponseToolConfig",
        validateParameters = {
...
public class InquirePageResponseToolConfigListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquirePageResponseToolConfigListService.class);
    ...
    public void execute() {
        ...
        List<ResponseToolConfig> entityList = enityPageMode.getDataList();
        if (entityList != null) {
