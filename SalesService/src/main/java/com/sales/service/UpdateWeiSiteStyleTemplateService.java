 ...
 */
@ServiceConfig(
        act = ActionNames.updateWeiSiteStyleTemplate,
        ...
        description = "修改WeiSiteStyleTemplate",
        validateParameters = {
...
public class UpdateWeiSiteStyleTemplateService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(UpdateWeiSiteStyleTemplateService.class);
