 ...
 */
@ServiceConfig(
        act = ActionNames.deleteEventConfig,
...
public class DeleteEventConfigService implements Service {
   
    private Logger logger = LogFactory.getInstance().getLogger(DeleteEventConfigService.class);
