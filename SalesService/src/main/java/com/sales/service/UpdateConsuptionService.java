 ...
 */
@ServiceConfig(
        act = ActionNames.updateConsuption,
...
public class UpdateConsuptionService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(UpdateConsuptionService.class);
    ...
    public void execute() {
        ...
        Consuption entity = entityDAO.update(parameters);
        if (entity != null) {
