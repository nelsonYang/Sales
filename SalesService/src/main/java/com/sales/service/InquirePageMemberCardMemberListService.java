 ...
 */
@ServiceConfig(
        act = ActionNames.inquirePageMemberCardMemberList,
        ...
        description = "分页查询MemberCardMember",
        validateParameters = {
...
public class InquirePageMemberCardMemberListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquirePageMemberCardMemberListService.class);
    ...
    public void execute() {
        ...
        List<MemberCardMember> entityList = enityPageMode.getDataList();
        if (entityList != null) {
