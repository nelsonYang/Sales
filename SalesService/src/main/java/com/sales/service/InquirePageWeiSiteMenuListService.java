 ...
 */
@ServiceConfig(
        act = ActionNames.inquirePageWeiSiteMenuList,
...
public class InquirePageWeiSiteMenuListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquirePageWeiSiteMenuListService.class);
    ...
    public void execute() {
        ...
        List<WeiSiteMenu> entityList = enityPageMode.getDataList();
        if (entityList != null) {
