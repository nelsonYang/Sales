 ...
 */
@ServiceConfig(
        act = ActionNames.insertWeiSiteMenu,
...
public class InsertWeiSiteMenuService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InsertWeiSiteMenuService.class);
    ...
    public void execute() {
        ...
        WeiSiteMenu entity = entityDAO.insert(parameters);
        if (entity != null) {
