 ...
 */
@ServiceConfig(
        act = ActionNames.insertMemberCardMember,
        ...
        description = "新增MemberCardMember",
        validateParameters = {
...
public class InsertMemberCardMemberService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InsertMemberCardMemberService.class);
    ...
    public void execute() {
        ...
        MemberCardMember entity = entityDAO.insert(parameters);
        if (entity != null) {
