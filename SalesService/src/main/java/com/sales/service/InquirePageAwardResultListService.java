 ...
 */
@ServiceConfig(
        act = ActionNames.inquirePageAwardResultList,
        ...
        returnParameters = {"awardResultId","awardSN","awardWeixinNO","awardMobileNO","awardTime","awardNum","awardStatus","companyId","operator","settleTime","awardId","eventId","weixinId"},
        description = "分页查询AwardResult",
        validateParameters = {
...
public class InquirePageAwardResultListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquirePageAwardResultListService.class);
    ...
    public void execute() {
        ...
        List<AwardResult> entityList = enityPageMode.getDataList();
        if (entityList != null) {
