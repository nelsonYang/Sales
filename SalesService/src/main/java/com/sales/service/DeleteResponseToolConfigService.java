 ...
 */
@ServiceConfig(
        act = ActionNames.deleteResponseToolConfig,
        ...
        description = "删除ResponseToolConfig操作",
        validateParameters = {
...
public class DeleteResponseToolConfigService implements Service {
   
    private Logger logger = LogFactory.getInstance().getLogger(DeleteResponseToolConfigService.class);
