...
public class InsertPayFlowService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InsertPayFlowService.class);
    ...
    public void execute() {
        ...
        PayFlow entity = entityDAO.insert(parameters);
        if (entity != null) {
