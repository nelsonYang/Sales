 ...
 */
@ServiceConfig(
        act = ActionNames.inquirePageWeiBarConfigList,
...
public class InquirePageWeiBarConfigListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquirePageWeiBarConfigListService.class);
    ...
    public void execute() {
        ...
        List<WeiBarConfig> entityList = enityPageMode.getDataList();
        if (entityList != null) {
