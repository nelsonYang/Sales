 ...
 */
@ServiceConfig(
        act = ActionNames.insertAwardResult,
...
public class InsertAwardResultService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InsertAwardResultService.class);
    ...
    public void execute() {
        ...
        AwardResult entity = entityDAO.insert(parameters);
        if (entity != null) {
