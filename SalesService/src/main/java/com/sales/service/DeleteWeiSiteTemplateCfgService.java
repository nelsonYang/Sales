 ...
 */
@ServiceConfig(
        act = ActionNames.deleteWeiSiteTemplateCfg,
        ...
        description = "删除WeiSiteTemplateCfg操作",
        validateParameters = {
...
public class DeleteWeiSiteTemplateCfgService implements Service {
   
    private Logger logger = LogFactory.getInstance().getLogger(DeleteWeiSiteTemplateCfgService.class);
