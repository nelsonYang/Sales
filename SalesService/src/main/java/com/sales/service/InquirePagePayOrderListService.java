 ...
 */
@ServiceConfig(
        act = ActionNames.inquirePagePayOrderList,
...
public class InquirePagePayOrderListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquirePagePayOrderListService.class);
    ...
    public void execute() {
        ...
        List<PayOrder> entityList = enityPageMode.getDataList();
        if (entityList != null) {
