 ...
 */
@ServiceConfig(
        act = ActionNames.inquirePagePayFlowList,
...
public class InquirePagePayFlowListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquirePagePayFlowListService.class);
    ...
    public void execute() {
        ...
        List<PayFlow> entityList = enityPageMode.getDataList();
        if (entityList != null) {
