 ...
 */
@ServiceConfig(
        act = ActionNames.inquireWeiSiteArticleList,
        ...
        description = "查询WeiSiteArticle配置",
        validateParameters = {
...
public class InquireWeiSiteArticleListService implements Service {
    ...
    private Logger logger = LogFactory.getInstance().getLogger(InquireWeiSiteArticleListService.class);
    ...
    public void execute() {
        ...
        List<WeiSiteArticle> entityList = entityDAO.inquireByCondition(conditionList);
        if (entityList != null) {
