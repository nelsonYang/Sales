 ...
 */
@ServiceConfig(
        act = ActionNames.insertPayOrder,
...
public class InsertPayOrderService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InsertPayOrderService.class);
    ...
    public void execute() {
        ...
        PayOrder entity = entityDAO.insert(parameters);
        if (entity != null) {
