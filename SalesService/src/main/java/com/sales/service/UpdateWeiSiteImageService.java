 ...
 */
@ServiceConfig(
        act = ActionNames.updateWeiSiteImage,
...
public class UpdateWeiSiteImageService implements Service {
    ...
    private Logger logger = LogFactory.getInstance().getLogger(UpdateWeiSiteImageService.class);
    ...
    public void execute() {
        ...
        WeiSiteImage entity = entityDAO.update(parameters);
        if (entity != null) {
