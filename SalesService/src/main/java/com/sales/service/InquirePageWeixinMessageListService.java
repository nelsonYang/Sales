 ...
 */
@ServiceConfig(
        act = ActionNames.inquirePageWeixinMessageList,
...
public class InquirePageWeixinMessageListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquirePageWeixinMessageListService.class);
    ...
    public void execute() {
        ...
        List<WeixinMessage> entityList = enityPageMode.getDataList();
        if (entityList != null) {
