 ...
 */
@ServiceConfig(
        act = ActionNames.deleteWeiSiteConfig,
...
public class DeleteWeiSiteConfigService implements Service {
   
    private Logger logger = LogFactory.getInstance().getLogger(DeleteWeiSiteConfigService.class);
