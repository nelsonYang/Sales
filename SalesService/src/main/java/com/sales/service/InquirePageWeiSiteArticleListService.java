 ...
 */
@ServiceConfig(
        act = ActionNames.inquirePageWeiSiteArticleList,
        ...
        description = "分页查询WeiSiteArticle",
        validateParameters = {
...
public class InquirePageWeiSiteArticleListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquirePageWeiSiteArticleListService.class);
    ...
    public void execute() {
        ...
        List<WeiSiteArticle> entityList = enityPageMode.getDataList();
        if (entityList != null) {
