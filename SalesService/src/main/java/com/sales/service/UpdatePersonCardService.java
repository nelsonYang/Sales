 ...
 */
@ServiceConfig(
        act = ActionNames.updatePersonCard,
        importantParameters = {"session", "encryptType","personCardId"},
        minorParameters = {"personName","personMobile","personEmail","personIconURL","companyName","companyAddress","readCount","clickCount","weiboNo","qqNO","companyId","createTime","messageTitle","messageImageURL","personCardDesc","personCardAddress","personLinkSite"},
...
public class UpdatePersonCardService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(UpdatePersonCardService.class);
    ...
    public void execute() {
        ...
        PersonCard entity = entityDAO.update(parameters);
        if (entity != null) {
