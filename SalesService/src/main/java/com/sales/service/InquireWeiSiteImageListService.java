 ...
 */
@ServiceConfig(
        act = ActionNames.inquireWeiSiteImageList,
...
public class InquireWeiSiteImageListService implements Service {
    ...
    private Logger logger = LogFactory.getInstance().getLogger(InquireWeiSiteImageListService.class);
    ...
    public void execute() {
        ...
        List<WeiSiteImage> entityList = entityDAO.inquireByCondition(conditionList);
        if (entityList != null) {
