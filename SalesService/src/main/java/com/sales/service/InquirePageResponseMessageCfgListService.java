 ...
 */
@ServiceConfig(
        act = ActionNames.inquirePageResponseMessageCfgList,
        ...
        returnParameters = {"responseMessageCfgId","responseContent","responseImageURL","responseAudio","type","companyId","relatedEventId","keyword","relatedURL","isClose","responseContentType","relatedId","matchType"},
        description = "分页查询ResponseMessageCfg",
        validateParameters = {
...
public class InquirePageResponseMessageCfgListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquirePageResponseMessageCfgListService.class);
    ...
    public void execute() {
        ...
        List<ResponseMessageCfg> entityList = enityPageMode.getDataList();
        if (entityList != null) {
