 ...
 */
@ServiceConfig(
        act = ActionNames.inquirePageAwardList,
...
public class InquirePageAwardListService implements Service {
    ...
    private Logger logger = LogFactory.getInstance().getLogger(InquirePageAwardListService.class);
    ...
    public void execute() {
        ...
        List<Award> entityList = enityPageMode.getDataList();
        if (entityList != null) {
