 ...
 * @author nelson
 */
public class MusicMessageHandler implements MessageHandler {
    ...
    public String handleMessage(Map<String, String> messageMap, WeixinReceiveAPI request, WeixinResponseAPI response) {
        ...
        weixinMessageMap.put("type", String.valueOf(MessageTypeEnum.music.ordinal()));
        ...
        weixinMessageMap.put("content", "音乐");
