 ...
 * @author nelson
 */
public class VedioMessageHandler implements MessageHandler {
    ...
    public String handleMessage(Map<String, String> messageMap, WeixinReceiveAPI request, WeixinResponseAPI response) {
        ...
        weixinMessageMap.put("type", String.valueOf(MessageTypeEnum.vedio.ordinal()));
        ...
        weixinMessageMap.put("content", "视频信息");
