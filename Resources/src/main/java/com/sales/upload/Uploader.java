...
public class Uploader {
        ...
        try {
            ...
            while (fii.hasNext()) {
                ...
                if (!fis.isFormField()) {
                    ...
                    this.url = applicationContext.getUploadURL() + File.separator + this.fileName;
                    BufferedInputStream in = new BufferedInputStream(fis.openStream());
                    FileOutputStream out = new FileOutputStream(new File(this.getPhysicalPath(this.fileName)));
    ...
    private String getFolder(String path) {
        ...
        return ApplicationContext.CTX.getUploadDir();
...
//                .getRealPath(servletPath);
        String uploadDir = applicationContext.getUploadDir() + File.separator + fileName;
        return uploadDir;
    }
