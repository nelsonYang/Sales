 ...
 */
@ServiceConfig(
        act = SalesActionName.insertResponseMessage,
        importantParameters = {"session", "encryptType", "keyword", "type"},
        minorParameters = {"responseContent", "responseImageURL", "responseAudio"},
...
public class InsertResponseMessageService implements Service {
    ...
    public void execute() {
        ...
        ResponseMessageCfg responseMessageCfg = responseMessageDAO.insert(parameters);
