 ...
 */
@ServiceConfig(
        act = ActionNames.inquirePagePersonCardList,
...
public class InquirePagePersonCardListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquirePagePersonCardListService.class);
    ...
    public void execute() {
        ...
        List<PersonCard> entityList = enityPageMode.getDataList();
        if (entityList != null) {
