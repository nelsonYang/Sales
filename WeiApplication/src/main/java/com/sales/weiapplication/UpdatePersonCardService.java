 ...
 */
@ServiceConfig(
        act = SalesActionName.updatePersonCard,
        importantParameters = {"session", "encryptType", "personCardId"},
        minorParameters = {"personIconURL", "companyName", "companyAddress","personName", "personMobile", "personEmail", "qqNO", "weiboNo"},
...
public class UpdatePersonCardService implements Service {
    ...
    public void execute() {
        ...
        PersonCard personCard = personCardDAO.update(parameters);
        if (personCard != null) {
