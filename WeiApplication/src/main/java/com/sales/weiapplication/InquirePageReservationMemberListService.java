 ...
 */
@ServiceConfig(
        act = ActionNames.inquirePageReservationMemberList,
...
public class InquirePageReservationMemberListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquirePageReservationMemberListService.class);
