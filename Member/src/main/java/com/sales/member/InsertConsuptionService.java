...
@ServiceConfig(
        ...
        minorParameters = {"couponId", "couponName", "availableCount", "consumeMoney", "operatorName"},
    ...
    @Field(fieldName = "operatorName", fieldType = FieldTypeEnum.CHAR24, description = "操作员"),
