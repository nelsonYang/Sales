 ...
 */
@ServiceConfig(
        act = ActionNames.inquirePageCouponConfigList,
...
public class InquirePageCouponConfigListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquirePageCouponConfigListService.class);
    ...
    public void execute() {
        ...
        List<CouponConfig> entityList = enityPageMode.getDataList();
        if (entityList != null) {
