 ...
 */
@ServiceConfig(
        act = ActionNames.inquirePageMemberCardLevelList,
        ...
        returnParameters = {"memberCardLevelId","memberCardLevelMin","memberCardLevelMax","memberCardLevel","memberCardBackgroupURL"},
        description = "分页查询MemberCardLevel",
        validateParameters = {
...
public class InquirePageMemberCardLevelListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquirePageMemberCardLevelListService.class);
    ...
    public void execute() {
        ...
        List<MemberCardLevel> entityList = enityPageMode.getDataList();
        if (entityList != null) {
