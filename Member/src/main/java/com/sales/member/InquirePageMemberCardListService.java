 ...
 */
@ServiceConfig(
        act = ActionNames.inquirePageMemberCardList,
...
public class InquirePageMemberCardListService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquirePageMemberCardListService.class);
    ...
    public void execute() {
        ...
        List<MemberCard> entityList = enityPageMode.getDataList();
        if (entityList != null) {
