 ...
 */
@ServiceConfig(
        act = ActionNames.inquireWeiSiteSytleTemplate,
        ...
        returnParameters = {"weiSiteStyleTemplateId", "weiSiteStyleTemplateCfgId"},
        description = "查询WeiSiteSytleTemplate",
        validateParameters = {
    @Field(fieldName = "session", fieldType = FieldTypeEnum.CHAR1024, description = "session信息"),
    @Field(fieldName = "encryptType", fieldType = FieldTypeEnum.TYINT, description = "加密类型")
})
public class InquireWeiSiteSytleTemplateService implements Service {

    private Logger logger = LogFactory.getInstance().getLogger(InquireWeiSiteSytleTemplateService.class);
